...
#include<unistd.h>//read;pause;sleep
#include<fcntl.h>
...
int GUIRender(){
    const char* wallElem = "▨ ";//strlen=4;常量字符串
    const char*  bodyElem = "● ";
    ...
    wallXElemN = 2*(winColByte / strlen(wallElem));//虽然一个元素存储占4字节，但显示只占2字节宽度。
